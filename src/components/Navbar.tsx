        ...
        <div className="max-w-[1920px] mx-auto px-6 h-[72px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[--accent]/30 transition-all duration-300 active:scale-95"
            >
              <div className="p-1 px-2 rounded-full bg-[--accent]/10 text-[--accent] text-[10px] font-bold tracking-tight">
                CONFIG
              </div>
              <div className="relative w-4 h-4">
                <svg className="w-full h-full text-gray-400 group-hover:text-white transition-colors animate-spin-slow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 bg-[--accent] rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
              </div>
            </button>
          </div>
        </div>
